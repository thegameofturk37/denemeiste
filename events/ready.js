...
var Games = [
    ...
    setInterval(function() {
        ...
        client.user.setGame(Games[random], "https://www.twitch.tv/Neptunebot");
        },  2500);
...
//client.channels.get('558313359670247434').send(`${rahatsız} **[Bağlandı]** **-** Bot Discorda Bağlandı ve Sunucularda Kullanıma Kapalı.`);
   ...
   var Games = [
        ...
        "» /davet",
        "» Web Sitemiz http://Neptuneforum.tk/",
  ...
  console.log(`BOT : Developed Neptune Coder Studios`)
